...
#define MCX_SRC_DISKARRAY  16  /**<  an arbitrary array of disk sources, srcparam1.x defines the amount of disks
 * and srcpattern is matrix of shape [ndisk x 7] with each row being the srcpos, srcdir, and radius of each disk*/
